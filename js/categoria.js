...
const categoriaPadrao = 'categoria-inicial'; // Substitua pela categoria desejada

// Filtra a categoria padrão ao carregar a página
grid.filter(`[data-categoria="${categoriaPadrao}"]`);
...
enlaces.forEach((elemento) => {
  elemento.addEventListener('click', (evento) => {
    ...
    /* Identifique a categoria do link que foi clicado */
